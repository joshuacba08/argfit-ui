...
Beta+ debe ampliar el catalogo sin romper la confianza ganada en beta. El objetivo no es agregar todos los componentes pendientes, sino sumar primitives de producto que aparecen en casi cualquier app enterprise: overlays ligeros, drawer, tooltip/help, progreso, identidad visual, chips y disclosure.
...
6. Roadmap y README de HUs enlazan Beta+.
