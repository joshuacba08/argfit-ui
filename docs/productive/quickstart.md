...
This guide describes the consumer posture for the stable `1.3.1` ArgFit UI contract.

The repository now validates stable `1.3.1` package metadata and production tarballs through the production release gate.
...
pnpm add @argfit-ui/primitives@1.3.1
pnpm add @argfit-ui/desktop@1.3.1 @argfit-ui/mobile@1.3.1
pnpm add @argfit-ui/adaptive@1.3.1
```
...
@Component({
  ...
  template: `
    <af-card variant="panel" tone="primary">
      ...
      <div afCardContent>
        <af-inline-message severity="info" title="1.3.1 stable">
...
- [Productive release notes](./release-notes-1.3.1.md)
