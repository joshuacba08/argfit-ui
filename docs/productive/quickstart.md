...
This guide describes the consumer posture for the stable `1.4.0` ArgFit UI contract.

The repository now validates stable `1.4.0` package metadata and production tarballs through the production release gate.
...
```bash
pnpm add @argfit-ui/core@1.4.0
pnpm add @argfit-ui/primitives@1.4.0
pnpm add @argfit-ui/desktop@1.4.0 @argfit-ui/mobile@1.4.0
pnpm add @argfit-ui/adaptive@1.4.0
```
...
@Component({
  ...
  template: `
    <af-card variant="panel" tone="primary">
      ...
      <div afCardContent>
        <af-inline-message severity="info" title="1.4.0 stable">
...
- [Productive release notes](./release-notes-1.4.0.md)
