...
@Component({
  selector: 'af-textarea-desktop',
  templateUrl: './af-textarea-desktop.component.html',
  styleUrl: './af-textarea-desktop.component.scss',
  changeDetection: ChangeDetectionStrategy.OnPush,
  encapsulation: ViewEncapsulation.None,
  host: {
    class: 'af-textarea-desktop',
    '[attr.data-size]': 'size()',
...
export class AfTextareaDesktopComponent {
  private readonly defaultTextareaId = `af-textarea-desktop-${++nextAfDesktopTextareaId}`;
