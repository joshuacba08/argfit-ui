...
let nextAfTabsDesktopId = 0;

@Component({
  selector: 'af-tabs-desktop',
  imports: [AfBadgeDesktopComponent, AfIconComponent, NgTemplateOutlet],
  templateUrl: './af-tabs-desktop.component.html',
  styleUrl: './af-tabs-desktop.component.scss',
...
export class AfTabsDesktopComponent {
  private readonly defaultTabsId = `af-tabs-desktop-${++nextAfTabsDesktopId}`;
