...
let nextAfDesktopInputCountId = 0;

@Component({
  selector: 'af-input-count-desktop',
  templateUrl: './af-input-count-desktop.component.html',
  styleUrl: './af-input-count-desktop.component.scss',
  changeDetection: ChangeDetectionStrategy.OnPush,
  encapsulation: ViewEncapsulation.None,
  host: {
    class: 'af-input-count-desktop',
    '[attr.data-size]': 'size()',
...
export class AfInputCountDesktopComponent {
  private readonly defaultInputId = `af-input-count-desktop-${++nextAfDesktopInputCountId}`;
