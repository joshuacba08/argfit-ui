...
let nextAfAccordionDesktopId = 0;

@Component({
  selector: 'af-accordion-desktop',
  imports: [AfBadgeDesktopComponent, AfIconComponent, NgTemplateOutlet],
  templateUrl: './af-accordion-desktop.component.html',
  styleUrl: './af-accordion-desktop.component.scss',
  changeDetection: ChangeDetectionStrategy.OnPush,
  encapsulation: ViewEncapsulation.None,
  host: {
    class: 'af-accordion-desktop',
    '[attr.data-density]': 'density()',
    '[attr.data-disabled]': 'disabled() ? "" : null',
  },
})
export class AfAccordionDesktopComponent {
  private readonly defaultAccordionId = `af-accordion-desktop-${++nextAfAccordionDesktopId}`;
