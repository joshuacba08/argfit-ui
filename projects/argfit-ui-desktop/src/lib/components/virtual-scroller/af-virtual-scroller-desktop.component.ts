...
type AfVirtualScrollerDesktopState = 'ready' | 'loading' | 'empty' | 'error';

interface AfVirtualScrollerDesktopWindow {
...
@Component({
  selector: 'af-virtual-scroller-desktop',
  imports: [AfBadgeDesktopComponent, AfIconComponent, NgTemplateOutlet],
  templateUrl: './af-virtual-scroller-desktop.component.html',
  styleUrl: './af-virtual-scroller-desktop.component.scss',
  changeDetection: ChangeDetectionStrategy.OnPush,
  encapsulation: ViewEncapsulation.None,
  host: {
    class: 'af-virtual-scroller-desktop',
    '[attr.data-density]': 'density()',
    '[attr.data-state]': 'state()',
  },
})
export class AfVirtualScrollerDesktopComponent {
  ...
  protected readonly state = computed<AfVirtualScrollerDesktopState>(() => {
    if (this.error()) {
      return 'error';
    }
  ...
  private buildWindow(scrollTop: number): AfVirtualScrollerDesktopWindow {
