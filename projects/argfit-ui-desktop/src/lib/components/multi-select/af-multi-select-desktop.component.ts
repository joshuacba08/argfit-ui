...
let nextAfDesktopMultiSelectId = 0;
...
@Component({
  ...
  host: {
    class: 'af-multi-select-desktop',
    '[attr.data-density]': 'density()',
    '[attr.data-disabled]': 'disabled() ? "" : null',
    '[attr.data-invalid]': 'errorText() ? "" : null',
  },
})
export class AfMultiSelectDesktopComponent {
  private readonly defaultInputId = `af-multi-select-desktop-${++nextAfDesktopMultiSelectId}`;
