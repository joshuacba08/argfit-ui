...
@Component({
  selector: 'af-popover-desktop',
  imports: [AfEscapeKeyDirective, AfFocusInitialDirective, AfFocusTrapDirective, NgTemplateOutlet],
  templateUrl: './af-popover-desktop.component.html',
  styleUrl: './af-popover-desktop.component.scss',
  changeDetection: ChangeDetectionStrategy.OnPush,
  encapsulation: ViewEncapsulation.None,
  host: {
    class: 'af-popover-desktop',
    '[attr.data-open]': 'open() ? "" : null',
  },
})
export class AfPopoverDesktopComponent {
  ...
  protected readonly id = nextAfDesktopPopoverId++;
  protected readonly titleId = `af-popover-desktop-${this.id}-title`;
