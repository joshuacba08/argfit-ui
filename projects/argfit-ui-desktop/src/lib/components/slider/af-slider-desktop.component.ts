...
let nextAfDesktopSliderId = 0;

/**
 * Desktop renderer for `AfSlider`.
 *
 ...
 */
@Component({
  selector: 'af-slider-desktop',
  templateUrl: './af-slider-desktop.component.html',
  styleUrl: './af-slider-desktop.component.scss',
  changeDetection: ChangeDetectionStrategy.OnPush,
  encapsulation: ViewEncapsulation.None,
  host: {
    class: 'af-slider-desktop',
    '[attr.data-size]': 'size()',
...
export class AfSliderDesktopComponent {
  private readonly defaultInputId = `af-slider-desktop-${++nextAfDesktopSliderId}`;
