...
@Component({
  selector: 'af-drawer-desktop',
  imports: [AfEscapeKeyDirective, AfFocusInitialDirective, AfFocusTrapDirective],
  templateUrl: './af-drawer-desktop.component.html',
  styleUrl: './af-drawer-desktop.component.scss',
  changeDetection: ChangeDetectionStrategy.OnPush,
  encapsulation: ViewEncapsulation.None,
  host: {
    class: 'af-drawer-desktop',
    '[attr.data-open]': 'open() ? "" : null',
  },
})
export class AfDrawerDesktopComponent {
  ...
  protected readonly id = nextAfDesktopDrawerId++;
  protected readonly titleId = `af-drawer-desktop-${this.id}-title`;
  protected readonly descriptionId = `af-drawer-desktop-${this.id}-desc`;
  ...
  private lockBodyScroll(): void {
    ...
    const scrollbarWidth = view ? view.innerWidth - this.document.documentElement.clientWidth : 0;
