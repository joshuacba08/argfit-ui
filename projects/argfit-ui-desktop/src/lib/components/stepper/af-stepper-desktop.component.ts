...
let nextAfStepperDesktopId = 0;

@Component({
  selector: 'af-stepper-desktop',
  imports: [NgTemplateOutlet],
  templateUrl: './af-stepper-desktop.component.html',
  styleUrl: './af-stepper-desktop.component.scss',
  changeDetection: ChangeDetectionStrategy.OnPush,
  encapsulation: ViewEncapsulation.None,
  host: {
    class: 'af-stepper-desktop',
    '[attr.data-density]': 'density()',
    '[attr.data-disabled]': 'disabled() ? "" : null',
  },
})
export class AfStepperDesktopComponent {
  private readonly defaultStepperId = `af-stepper-desktop-${++nextAfStepperDesktopId}`;
