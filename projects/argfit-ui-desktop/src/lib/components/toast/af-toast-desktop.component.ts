...
@Component({
  selector: 'af-toast-desktop',
  imports: [AfIconComponent],
  templateUrl: './af-toast-desktop.component.html',
  styleUrl: './af-toast-desktop.component.scss',
  changeDetection: ChangeDetectionStrategy.OnPush,
  encapsulation: ViewEncapsulation.None,
  host: {
    class: 'af-toast-desktop',
...
export class AfToastDesktopComponent {
