...
/**
 * Desktop renderer for `AfSkeleton`.
 */
@Component({
  selector: 'af-skeleton-desktop',
  templateUrl: './af-skeleton-desktop.component.html',
  styleUrl: './af-skeleton-desktop.component.scss',
  changeDetection: ChangeDetectionStrategy.OnPush,
  encapsulation: ViewEncapsulation.None,
  host: {
    class: 'af-skeleton-desktop',
...
export class AfSkeletonDesktopComponent {
