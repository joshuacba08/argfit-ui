...
Desktop renderer package for ArgFit UI `2.1.0`.
...
```bash
pnpm add @argfit-ui/core@2.1.0 @argfit-ui/primitives@2.1.0 @argfit-ui/chart-runtime@2.1.0 @argfit-ui/desktop@2.1.0
