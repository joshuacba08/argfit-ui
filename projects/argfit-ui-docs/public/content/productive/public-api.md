...
This document records the public API surface for `2.2.0`.
...
Any export reachable through those barrels inherits the `2.0` category assigned below. There is no public `experimental` category in the `2.2.0` contract.
