...
import { AfButtonMobileComponent } from '../button/af-button-mobile.component';

/**
 * Mobile renderer for `AfEmptyState`.
 */
@Component({
  selector: 'af-empty-state-mobile',
  imports: [AfIconComponent, AfButtonMobileComponent],
  templateUrl: './af-empty-state-mobile.component.html',
  styleUrl: './af-empty-state-mobile.component.scss',
  changeDetection: ChangeDetectionStrategy.OnPush,
  encapsulation: ViewEncapsulation.None,
  host: {
    class: 'af-empty-state-mobile',
    '[attr.data-tone]': 'tone()',
    '[attr.data-size]': 'size()',
    '[attr.role]': 'tone() === "error" ? "alert" : "status"',
  },
})
export class AfEmptyStateMobileComponent {
