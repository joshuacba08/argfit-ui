...
let nextAfMobileFileUploadId = 0;

/**
 * Mobile renderer for `AfFileUpload`.
 *
 ...
 */
@Component({
  selector: 'af-file-upload-mobile',
  imports: [AfIconComponent],
  templateUrl: './af-file-upload-mobile.component.html',
  styleUrl: './af-file-upload-mobile.component.scss',
  changeDetection: ChangeDetectionStrategy.OnPush,
  encapsulation: ViewEncapsulation.None,
  host: {
    class: 'af-file-upload-mobile',
    '[attr.data-size]': 'size()',
...
export class AfFileUploadMobileComponent {
  private readonly defaultInputId = `af-file-upload-mobile-${++nextAfMobileFileUploadId}`;
