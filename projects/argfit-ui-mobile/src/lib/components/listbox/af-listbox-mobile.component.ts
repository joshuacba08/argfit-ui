...
let nextAfMobileListboxId = 0;

@Component({
  selector: 'af-listbox-mobile',
  templateUrl: './af-listbox-mobile.component.html',
  styleUrl: './af-listbox-mobile.component.scss',
  changeDetection: ChangeDetectionStrategy.OnPush,
  encapsulation: ViewEncapsulation.None,
  host: {
    class: 'af-listbox-mobile',
...
export class AfListboxMobileComponent {
  private readonly defaultInputId = `af-listbox-mobile-${++nextAfMobileListboxId}`;
  ...
  protected onOptionBlur(event: FocusEvent): void {
    ...
    const panel = currentTarget?.closest('.af-listbox-mobile__panel');
