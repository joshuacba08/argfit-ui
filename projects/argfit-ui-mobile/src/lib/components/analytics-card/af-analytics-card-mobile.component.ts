...
@Component({
  selector: 'af-analytics-card-mobile',
  imports: [AfIconComponent, NgTemplateOutlet],
  templateUrl: './af-analytics-card-mobile.component.html',
  styleUrl: './af-analytics-card-mobile.component.scss',
  changeDetection: ChangeDetectionStrategy.OnPush,
  encapsulation: ViewEncapsulation.None,
  host: {
    class: 'af-analytics-card-mobile',
    '[class]': 'hostClasses()',
...
export class AfAnalyticsCardMobileComponent {
  ...
  protected readonly hostClasses = computed(() =>
    [
      ...
      `af-analytics-card-mobile--${this.variant()}`,
