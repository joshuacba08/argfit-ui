...
let nextAfMobileSegmentedControlId = 0;

@Component({
  selector: 'af-segmented-control-mobile',
  templateUrl: './af-segmented-control-mobile.component.html',
  styleUrl: './af-segmented-control-mobile.component.scss',
  changeDetection: ChangeDetectionStrategy.OnPush,
  encapsulation: ViewEncapsulation.None,
  schemas: [CUSTOM_ELEMENTS_SCHEMA],
  host: {
    class: 'af-segmented-control-mobile',
    '[attr.data-size]': 'size()',
    '[attr.data-state]': 'effectiveState()',
    '[attr.data-disabled]': 'disabled() ? "" : null',
  },
})
export class AfSegmentedControlMobileComponent {
  private readonly defaultSegmentedControlId = `af-segmented-control-mobile-${++nextAfMobileSegmentedControlId}`;
