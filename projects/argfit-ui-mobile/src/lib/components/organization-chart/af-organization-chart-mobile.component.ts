...
type AfOrganizationChartMobileState = 'ready' | 'loading' | 'empty' | 'error';

@Component({
  selector: 'af-organization-chart-mobile',
  imports: [AfAvatarMobileComponent, AfBadgeMobileComponent, AfIconComponent, NgTemplateOutlet],
  templateUrl: './af-organization-chart-mobile.component.html',
  styleUrl: './af-organization-chart-mobile.component.scss',
  changeDetection: ChangeDetectionStrategy.OnPush,
  encapsulation: ViewEncapsulation.None,
  host: {
    class: 'af-organization-chart-mobile',
    '[attr.data-density]': 'density()',
    '[attr.data-state]': 'state()',
    '[attr.data-disabled]': 'disabled() ? "" : null',
  },
})
export class AfOrganizationChartMobileComponent {
  ...
  protected readonly state = computed<AfOrganizationChartMobileState>(() => {
    if (this.error()) {
      return 'error';
    }
