...
Primary consumer component package for ArgFit UI `1.1.0`.
...
This package participates in the current `1.1.0` production contract.
...
```bash
pnpm add @argfit-ui/core@1.1.0 @argfit-ui/primitives@1.1.0
pnpm add @argfit-ui/desktop@1.1.0 @argfit-ui/mobile@1.1.0 @argfit-ui/adaptive@1.1.0
...
- [Release notes](https://github.com/joshuacba08/argfit-ui/blob/main/docs/productive/release-notes-1.1.0.md)
