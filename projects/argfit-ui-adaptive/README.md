...
Primary consumer component package for ArgFit UI `2.2.0`.
...
This package participates in the current `2.2.0` production contract.
...
```bash
pnpm add @argfit-ui/core@2.2.0 @argfit-ui/primitives@2.2.0
pnpm add @argfit-ui/desktop@2.2.0 @argfit-ui/mobile@2.2.0 @argfit-ui/adaptive@2.2.0 @argfit-ui/chart-runtime@2.2.0
