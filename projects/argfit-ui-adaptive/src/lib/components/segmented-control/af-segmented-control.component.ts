...
import { AfSegmentedControlDesktopComponent } from '@argfit-ui/desktop';
import { AfSegmentedControlMobileComponent } from '@argfit-ui/mobile';

@Component({
  selector: 'af-segmented-control',
  imports: [AfSegmentedControlDesktopComponent, AfSegmentedControlMobileComponent],
  templateUrl: './af-segmented-control.component.html',
  styleUrl: './af-segmented-control.component.scss',
  changeDetection: ChangeDetectionStrategy.OnPush,
  providers: [
    {
      provide: NG_VALUE_ACCESSOR,
      useExisting: forwardRef(() => AfSegmentedControlComponent),
      multi: true,
    },
  ],
})
export class AfSegmentedControlComponent implements ControlValueAccessor {
