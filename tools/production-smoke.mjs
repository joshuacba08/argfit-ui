...
const PRODUCTION_VERSION = '1.3.1';
const failures = [];
...
function validateDocsShape() {
  for (const [filePath, snippets] of [
    ['package.json', ['"version": "1.3.1"', '"pack:production:dist"', '"release:production:check"', '"smoke:production:dist"', '"measure:production-performance:dist"']],
    ...
    ['docs/productive/scope.md', ['ArgFit UI 1.3.1 Scope', '`1.0-adaptive`']],
    ...
    ['docs/productive/release-checklist.md', ['Production Release Checklist', '1.3.1', 'pnpm release:production:check', 'v1.3.1', 'latest']],
    ['docs/productive/release-notes-1.3.1.md', ['Release Notes: 1.3.1', 'latest', 'pnpm release:production:check', 'dist/production-tarballs/']],
    ['CHANGELOG.md', ['## 1.3.1', 'latest', 'pnpm release:production:check']],
  ]) {
