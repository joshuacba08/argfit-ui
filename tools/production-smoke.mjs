...
function validateDocsShape() {
  for (const [filePath, snippets] of [
    ['package.json', ['"version": "1.1.0"', '"pack:production:dist"', '"release:production:check"', '"smoke:production:dist"', '"measure:production-performance:dist"']],
    ...
    ['docs/productive/scope.md', ['ArgFit UI 1.1.0 Scope', '`1.0-adaptive`']],
    ...
    ['docs/productive/release-checklist.md', ['Production Release Checklist', '1.1.0', 'pnpm release:production:check', 'v1.1.0', 'latest']],
    ['docs/productive/release-notes-1.1.0.md', ['Release Notes: 1.1.0', 'latest', 'pnpm release:production:check', 'dist/production-tarballs/']],
    ['CHANGELOG.md', ['## 1.1.0', 'latest dist-tag', 'pnpm release:production:check']],
  ]) {
